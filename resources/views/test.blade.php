...
<body>
    ...
    <!-- <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $product->price }}</td>
                <td>{{ $product->pivot->quantity * $product->price - $product->pivot->quantity * $product->price * $product->pivot->discount/100 }}</td>
            </tr>
            @endforeach
        </tbody>
    </table> -->
    ...
    <div class="contenedor">
        <div class="cabeza">
            <img src="https://i.imgur.com/wYIWjYj.png" class="logo">
            <div class="presupuesto">PRESUPUESTO</div>
            <div class="datadimsport">
        ...
        <div class="datacliente">
            ...
            <div class="infocliente">
                ...
                <span style = "background-color: black; z-index: 34">lore ipsum dolor sit amet, consectetur adipiscing elit. Donec euismod, nisl eget congue consectetur, nisl nunc aliquet nunc, euismod aliquam eros nunc euismod eros.</span>
            </div>
            <div class="fechacliente">
                <strong>Presupuesto:</strong> {{$invoice->code}}<br>
                <strong>Fecha:</strong> 2020-07-22<br>
                <strong>Fecha caducidad:</strong>  2020-07-31
            </div>
        </div>
        ...
        <div class="total">
            <table class="tablaventa">
                ...
                <tr class="proitem">
                    ...
                    <td>{{ $invoice->subtotal }}€</td>
                    <td>{{ $invoice->iva }}</td>
                    <td>{{ number_format($invoice->iva/100 * $invoice->subtotal, 2) }}€</td>
                    <td>{{ $invoice->total }}€</td>                    
                </tr>
        ...
        <div class="observaciones">
            ...
            <table class="tablaventa">
                ...
                <tr class="subitem">
                    <td class="obs">Forma de pago: {{ $invoice->payment }}</td>
                </tr>
